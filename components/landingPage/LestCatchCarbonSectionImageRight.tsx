...
const LestCatchCarbonSectionImageRight = () => {
  ...
  return (
    <motion.div
      ...
      className="w-full h-full flex justify-center items-end bg-center bg-cover bg-no-repeat rounded-2xl bg-[url('/Images/card-program/Pépinière-1.webp')] cursor-pointer"
    >
      <motion.div
        ...
        {/* {showButton && (
          <div className="flex flex-col items-center space-y-4 mb-8"> 
            <p className="text-white text-xs 2xl:text-sm 8xl:text-lg 10xl:text-2xl 12xl:text-3xl 13xl:text-[2.8rem] font-normal text-center relative bottom-[7%] 2xl:bottom-[11%] 13xl:leading-[3.4rem]">
              Coordination de l'action, <br /> méthodo sur le terrain... <br /> On
              vous explique.
            </p>
            <p className="px-10 py-3 mid-xl:py-[0.7rem] 2xl:px-9 8xl:px-[3rem] 9xl:px-7 9xl:py-4 10xl:px-10 10xl:py-5 11xl:px-14 12xl:py-6 13xl:px-[4rem] 13xl:py-8 text-black bg-white hover:bg-slate-50 text-sm 2xl:text-sm 8xl:text-lg 10xl:text-2xl 12xl:text-3xl 13xl:text-[2.8rem] font-normal rounded-full cursor-pointer relative bottom-[14%]">
              Choisir
            </p>
          </div>
        )} */}
...
export default LestCatchCarbonSectionImageRight;
