    ...
    <div className="w-full h-full flex flex-col justify-center items-center group cursor-pointer">
      <section className="w-full h-[40%] flex justify-center items-start rounded-t-2xl bg-center bg-cover bg-no-repeat bg-[url('/Images/lab-people.webp')]">
        <div className="w-full h-[30%] flex justify-end items-center gap-3">
          <div className="size-9 8xl:size-11 9xl:size-12 11xl:size-14 13xl:size-16 bg-[#02a0f5] rounded-full flex-center">
            <Image
          ...
          <p className="text-gray-900 bg-[#02a0f5] font-normal text-xs 2xl:text-lg 10xl:text-xl 11xl:text-2xl 13xl:text-4xl py-2.5 px-5 rounded-full mr-3">
            Accèss à l'eau
          </p>
        </div>
      </section>
      <section className="w-full h-[60%] flex-center rounded-b-2xl bg-white group-hover:bg-[#fcfecd] group-hover:shadow-lg">
        <div className="w-[90%] h-[90%] flex flex-col justify-between items-start">
          ...
          <div className="w-full flex justify-start items-center relative bottom-[0%]">
            <Image
          ...
          <div className="w-full h-[7%] rounded-full flex-center">
            <section className="w-[20%] h-full bg-[#00a5f5] rounded-l-full flex-center">
              <p className="text-xs 8xl:text-sm 10xl:text-base 12xl:text-lg 13xl:text-2xl font-light relative left-[3%]">
                700 €
              </p>
            </section>
            <section className="w-[80%] h-full bg-[#fdf9e9] rounded-r-full"></section>
          </div>
        </div>
      </section>
    </div>
...
export default SectionFiveWaterCard;
