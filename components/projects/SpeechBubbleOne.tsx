...
const SpeechBubbleOne = () => {
  return (
    <div className="w-full h-[20%] flex flex-col justify-center items-center">
      <div className="w-full h-[40%] flex-center mb-1">
        ...
        <div className="w-[55%] h-full flex flex-col justify-center items-start">
          ...
          <p className="text-sm 8xl:text-[0.95rem] 10xl:text-base 11xl:text-[1.2rem] 12xl:text-[1.4rem] 13xl:text-[1.6rem] font-extralight 11xl:mb-1 12xl:mb-[0.5rem] 13xl:mb-[0.7rem] text-gray-900 relative 8xl:right-[6%]">
            a fait un{" "}
            <span className="font-semibold text-blue-400">don de 25€</span>
          </p>
        </div>
        <div className="w-[30%] h-full flex justify-end items-start">
          <p className="text-[0.7rem] 8xl:text-[0.78rem] 10xl:text-[0.95rem] 11xl:text-[1rem] 12xl:text-[1.3rem] 13xl:text-[1.6rem] font-normal text-zinc-300">
            IL Y A 2 JOURS
          </p>
        </div>
      </div>
      <div className="w-full h-[60%] flex justify-end items-center">
        <div className="w-[95%] h-full flex justify-center items-center">
          <div className={`size-6 ${styles['speech-buble-triangle']} relative left-[3%] bottom-[35%] 10xl:left-[3%] 10xl:bottom-[40%] 11xl:left-[1.9%] 13xl:left-[2.5%]`}></div>
          <div className="w-full h-full bg-[#fdf9e9] rounded-full flex-center">
            <p className="w-[85%] text-slate-900 font-thin text-[0.7rem] 9xl:text-[0.85rem] 10xl:text-[0.95rem] 11xl:text-[1.1rem] 12xl:text-[1.2rem] 13xl:text-[1.5rem]">
              Ce don de 25€ marque un pas significatif vers la production d'un
              café durable et qualitatif.
            </p>
          </div>
        </div>
      </div>
